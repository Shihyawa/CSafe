...
void saveSetting() {
	log_error("Saved setting: ", EnableStaticEngine, EnableDynamicEngine, EnableDLLInject, CSafeAntivirusEngine::LSProtectEnableSensitiveMode, CSafeAntivirusEngine::EnableLSProtect, CSafeAntivirusEngine::BITProtectBlackWeight);
...
void loadSetting() {
	...
	inFile.close();
	log_error("Loaded setting: ", EnableStaticEngine, EnableDynamicEngine, EnableDLLInject, CSafeAntivirusEngine::LSProtectEnableSensitiveMode, CSafeAntivirusEngine::EnableLSProtect, CSafeAntivirusEngine::BITProtectBlackWeight);
}
